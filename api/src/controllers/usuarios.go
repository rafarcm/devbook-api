...
// AtualizarUsuario atualiza um usuário salvo no banco de dados
...
// AtualizarSenha atualiza a senha de um dado usuário
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if erro = seguranca.VerificarSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("a senha atual não condiz com a senha que esta no banco"))
		return
	}
