...
// CarregarPaginaDeCadastroDeUsuario vai carregar a tela de cadastro de usuário
func CarregarPaginaDeCadastroDeUsuario(w http.ResponseWriter, r *http.Request) {
	utils.ExecutarTemplate(w, "cadastro.html", nil)
}

// CarregarPaginaPrincipal vai carregar a tela principal do usuário
...
// CarregarPaginaPrincCarregarPaginaDeAtualizacaoDePublicacaoipal vai carregar a tela de edição de publiação
...
// CarregarPaginaDeEdicaoDeUsuario carrega a página de edição dos dados do usuário
