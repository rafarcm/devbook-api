...
// Usuario representa um usuário utlizando a rede social
type Usuario struct {
	ID          uint64       `json:"id"`
...
// BuscarUsuarioCompleto faz 4 requisições na API para montar o usuário com todos os dados
	...
	for i := 0; i < 4; i++ {
		...
		case seguindoCarregados := <-canalSeguindo:
			if seguindoCarregados == nil {
				return Usuario{}, errors.New("erro ao buscar quem o usuário esta seguindo")
			}
...
// buscarSeguindo chama a API para buscar quem esta seguindo o usuário
...
// buscarSeguindo chama a API para buscar as publicações do usuário
